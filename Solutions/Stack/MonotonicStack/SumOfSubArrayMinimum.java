...
public class SumOfSubArrayMinimum {
    public int sumSubarrayMins(int[] arr) {
        ...
        //for every element We have to find smallest element on both side that limits the range of current element to be minimum
        //Every element popped from stack the top element in stack is left min and current is right min
